    ...
    <div className="legal-page app-shell-light">
      ...
      <main className="legal-page-content">
        <section className="card legal-card">
          <p>These placeholder Terms and Conditions describe the basic expectations for using MARGIN. By using the app, you agree to use it responsibly and understand that its planning suggestions are informational tools rather than professional medical, financial, or legal advice.</p>
